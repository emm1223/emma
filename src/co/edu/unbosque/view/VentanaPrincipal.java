...
public class VentanaPrincipal extends JFrame {
    ...
    private void inicializarComponentes() {
        ...
        contenedorVentanas = new JPanel(gestorPantallas);
        ...
        contenedorJuego.add(panelEstadisticas, BorderLayout.EAST);

        // Registro de pantallas en el manejador de tarjetas
        contenedorVentanas.add(panelConfiguracion, "CONFIG");
        contenedorVentanas.add(contenedorJuego, "JUEGO");

        // Añade el contenedor maestro al marco del JFrame
        add(contenedorVentanas);
    }
    ...
    public void mostrarPanelJuego() {
        gestorPantallas.show(contenedorVentanas, "JUEGO");
    }
    ...
    public void mostrarPanelConfiguracion() {
        gestorPantallas.show(contenedorVentanas, "CONFIG");
    }

    // Getters indispensables para que el Controller pueda interactuar con cada
    // sección
