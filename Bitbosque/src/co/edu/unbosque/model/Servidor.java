...
public class Servidor {
        ...
        for (int[] dir : direcciones) {
            ...
            if (nf >= 0 && nf < filas && nc >= 0 && nc < columnas) {
                ...
                if (tipo.equals("ANTIVIRUS")) {
                    if (!hacker.isModoSigiloActivo()) {
                        hacker.setMovimientosRestantes(0); // Derrota instantánea
                    } else {
                        hacker.setModoSigiloActivo(false); // Quema el sigilo
                    }
    ...
    public boolean verificarDerrota() {
        return hacker.getMovimientosRestantes() <= 0;
    }
    ...
    public void activarModoSigilo() {
        hacker.setModoSigiloActivo(true);
        hacker.setSigiloUsado(true);
    }
